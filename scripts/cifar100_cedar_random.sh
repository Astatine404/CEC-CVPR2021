...
python train_fact.py project@_global_=fact_cifar100_random wandb_log=True seed=1 wandb_run_name=random_fact_${dataset_id} dataset_dir=random_${dataset_id}
